...
def TrainBubbleResNet20(useGrayscale, continueTraining = False):
    # Hyperparameters
    imgSize = ((1, 40, 50) if useGrayscale else (3, 40, 50))
    inputImageSize = ((1, 1, 40, 50) if useGrayscale else (1, 3, 40, 50))
    dropOutRate = 0.9 
    learningRate = 0.1
    numEpochs = 20 
    weightDecay = 0.0
    batchSize = 64
    # Initialize model
    model = resnet20(inputShape = inputImageSize, dropOutRate = dropOutRate, numClasses = 2)
    # Loss and optimizer
...
def TrainCombinedResNet20(useGrayscale, continueTraining = False):
    # Hyperparameters
    imgSize = ((1, 40, 50) if useGrayscale else (3, 40, 50))
    inputImageSize = ((1, 1, 40, 50) if useGrayscale else (1, 3, 40, 50))
    dropOutRate = 1.0 
...
TrainCombinedResNet20(useGrayscale=True, continueTraining = False)